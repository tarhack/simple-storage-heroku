...
module.exports = {
 ...
 networks: {
   ...
   development: {
     ...
     port: 7545,            // Standard Ethereum port (default: Ganache)
     network_id: "5777",    // Any network (default: Ganache)
   },
   rinkeby: {
     provider: function() {
   ...
   ropsten: {
     provider: function() {
       console.log('MN:'+process.env.MNEMONIC+' infura:'+process.env.INFURA_ID)
